...
| rds\_subnet\_cidr\_block\_filter | List of CIDR blocks to filter subnets of the VPC where the RDS component of the Microservice resides | list | `[]` | no |
...
| redis\_subnet\_cidr\_block\_filter | List of CIDR blocks to filter subnets of the VPC where the Redis component of the Microservice resides | list | `[]` | no |
