...
output "this_redis_subnet_group_id" {
  ...
  value       = "${element(concat(aws_elasticache_subnet_group.this.*.id, list("")), 0)}"
}
...
output "this_redis_replication_group_id" {
  ...
  value       = "${element(concat(aws_elasticache_replication_group.this.*.id, list("")), 0)}"
}
...
output "this_redis_replication_group_replication_group_id" {
  ...
  value       = "${element(concat(aws_elasticache_replication_group.this.*.replication_group_id, list("")), 0)}"
}
...
output "this_redis_replication_group_number_cache_clusters" {
  ...
  value       = "${element(concat(aws_elasticache_replication_group.this.*.number_cache_clusters, list("")), 0)}"
}
...
output "public_redis_endpoint_aws_route53_record" {
  ...
  value       = "${element(concat(aws_route53_record.public_redis_endpoint.*.fqdn, list("")), 0)}"
}
...
output "private_redis_endpoint_aws_route53_record" {
  ...
  value       = "${element(concat(aws_route53_record.private_redis_endpoint.*.fqdn, list("")), 0)}"
}
...
output "public_rds_endpoint_aws_route53_record" {
  description = "Public Redis cluster end-point address (should be used by the service)"
  value       = "${element(concat(aws_route53_record.public_rds_endpoint.*.fqdn, list("")), 0)}"
}

output "private_rds_endpoint_aws_route53_record" {
  description = "Private Redis cluster end-point address (should be used by the service)"
  value       = "${element(concat(aws_route53_record.private_rds_endpoint.*.fqdn, list("")), 0)}"
}
